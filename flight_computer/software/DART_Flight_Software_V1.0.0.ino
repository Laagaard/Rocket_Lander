...
/*
       ...
       |_____/|______\_____|______/_/    \_\_|  \_\/_/    \_\_|  |_____\____/|_| \_|____*/
                ...
                static int millisecondUpdateRate = 20; //updates every 20 ms
...
void loop() {
  ...
  switch(machineState){
    ...
    case 2: awaitLiftoff();   
            break;
    case 3: poweredAscent();
            break;
    case 4: unpoweredAscent();
            break;
    case 5: unpoweredDescent();  
            break;
    case 6: terminalDescent();
            break;
    case 7: landed();
            break;
    case 86: inFlightAbort();
            break;
