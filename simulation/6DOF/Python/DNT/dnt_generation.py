...
dnt_temporal_resolution = 0.25 # [s] time-step of each DNT discretization, be careful setting too high or too low
...
for idx in range(len(dnt_left_boundary_xs)):
    ...
    dnt_points_writer.writerow([round(t, 2), x_1, y_1, x_2, y_2])
